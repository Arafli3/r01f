...
def RVM_main():
    ...
    if gmelist:
        ...
        while not exittol:
            ...
            print(f" \033[91m┃\033[0m \033[94m          RENEWAL VMESS USER          \033[0m\033[91m ┃\033[0m")
            print(f" \033[94m╚═\033[0m\033[91m─────────────────────────────────────\033[0m\033[94m═╝\033[0m")
            ...
            if listnum.lower() == 'x':
                ...
                pathfils2 = f"/etc/qos/xray/usage/{nama_user}"
                ...
                while not exittol:
                    pathfilse2 = f"/etc/qos/xray/usage/{nama_user}"
                    ...
                    if confirm == 'y':
                        ...
                        if dataquo == "unlimited":
                            ...
                            break
                        while True:
                            lolcat("\nPress 'X' to go back to VMESS menu/cancel or (Ctrl + X) to exit.\n")
                            lolcat("  \nAdd Quotaa \n")
                            try:
                ...
                while True:
                    ...
                    try:
                        ...
                        if masaaktif == "x":
                            print(" \033[93mExiting the VMESS renewal process.\033[0m")
                            time.sleep(0.5)
                            back.vmess_menu()
                            return
                ...
                time.sleep(1)
        pathfil2 = f"/etc/qos/xray/usage/{nama_user}"
        ...
        print(f" \033[94m╚═\033[0m\033[91m─────────────────────────────────────\033[0m\033[94m═╝\033[0m")
        print("")
        print(f" \033[94m#########\033[0m\033[93m Vmess Account \033[0m\033[91m#########\033[0m")
        print(f" \033[94m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[0m")
