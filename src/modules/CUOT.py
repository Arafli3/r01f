...
def gmer01fuser():
    user_file = "/etc/qos/xray/trojan.txt"
    users = []
...
def trojan_on():
    ...
    if not users_check:
        while True:
            ...
            print("\033[31m┃\033[0m \033[1;31;44;1m          TROJAN ONLINE USER          \033[0m\033[31m ┃\033[0m")
            print("\033[34m╚═─────────────────────────────────────═╝\033[0m")
            print("")
            ...
            if user_input.lower() == "":
                print(f"\033[93mExiting the TROJAN User Online process.\033[0m")
                time.sleep(0.5)
                back.trojan_menu()
                return
            else:
        ...
        if gmelog:
            ...
            while True:
                ...
                print(f"      \033[94m━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m")
                print(f"   \033[92m𝐓𝐇𝐀𝐍𝐊 𝐘𝐎𝐔 𝐅𝐎𝐑 𝐔𝐒𝐈𝐍𝐆 𝐑𝟎𝟏𝐅 𝐓𝐔𝐍𝐍𝐄𝐋𝐈𝐍𝐆\033[0m")
                lolcat("\n Input X to go back to TROJAN menu or ( Ctrl + X )to exit.\n")
