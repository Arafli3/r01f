...
def Delete_vless():
    ...
    if gmelist:
        while True:
            ...
            print(f" \033[91m┃\033[0m \033[94m          DELETE VLESS USER          \033[0m\033[91m ┃\033[0m")
            print(f" \033[94m╚═\033[0m\033[91m─────────────────────────────────────\033[0m\033[94m═╝\033[0m")
            ...
            if listnum.lower() == "x":
                print(f"\033[93mExiting the VLESS delete process.\033[0m")
                time.sleep(0.5)
                clear_screen()
                back.vless_menu()
                return
            ...
            while True:
                ...
                if konfirmasi == "y":
                    ...
                    config_data["inbounds"][3]["settings"]["clients"] = clientsws
                    updatedgrpc = [client for client in clients_grpc if client["email"] not in user_delete]
                    config_data["inbounds"][4]["settings"]["clients"] = updatedgrpc
                    ...
                    for nama_user in user_delete:
                        relatedfiles = [
                            ...
                            f"/etc/xraylog/log-vless-{nama_user}.txt",
                            f"/var/www/html/vless-{nama_user}",
                    ...
                    while True:
                        ...
                        if action == "x":
                            print("\033[93m Exiting VLESS Account Delete Process\033[0m")
                            time.sleep(0.5)
                            os.system("clear")
                            back.vless_menu()
                            break
